...
namespace ParametricDramDirectoryMSI
{
   ...
   class CacheParameters
   {
      public:
         ...
         bool is_zcache; //Added for zcache
         bool perfect;
         bool coherent;
         ...
         CacheParameters(
            ...
            String _hash_function, String _replacement_policy, bool _is_zcache, bool _perfect, bool _coherent,
         ...
         :
            ...
            hash_function(_hash_function), replacement_policy(_replacement_policy), is_zcache(_is_zcache), perfect(_perfect), coherent(_coherent),
